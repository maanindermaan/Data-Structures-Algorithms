...
public:
    ...
    int solveUsingSOBASIC(vector<int>&prices , int i , int buy , int limit){
    ...
    int maxProfit(vector<int>& prices) {
        ...
        // return solveUsingRecursion(prices , 0 , true , limit);

        // vector<vector<vector<int>>>dp(prices.size()+1 , vector<vector<int>>(2 , vector<int>(3 , -1)));
        // return solveUsingMemo(prices , 0 , true , limit , dp);

        // return solveUsingTab(prices , 0 , true , limit);

        // return solveUsingSO(prices , 0 , true , limit);

        return solveUsingSOBASIC(prices , 0 , true , limit);
    }
};